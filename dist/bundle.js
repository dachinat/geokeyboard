...
var insertAtCaret = __webpack_require__(329);
...
var Geokeyboard = function () {
    function Geokeyboard(selectors) {
        ...
        selectors.split(", ").forEach(function (selector) {
            return _this.constructor._badSelector(selector);
        });
    ...
    _createClass(Geokeyboard, [{
        ...
        value: function listen(target) {
            ...
            if (typeof target === 'string' || target instanceof String) {
                if (this.constructor._badSelector) {
                    return this;
                }
            ...
            var targetElement = target.tagName.toLowerCase() === 'iframe' ? (target.contentWindow || target.contentDocument).window : target;

            // if (this.params.replaceOnType) {
            //     targetElement.addEventListener('keypress', e => this.constructor._replaceTyped.call(this, target, e));
            // }

            if (this.params.replaceOnType) {
                targetElement.addEventListener('keypress', this.constructor._replaceTyped.bind(this));
            }

            if (this.params.replaceOnPaste) {
                targetElement.addEventListener('paste', function (e) {
                    return _this2.constructor._replacePasted.call(_this2, target, e);
                });
            }
        ...
        value: function unlisten() {
            ...
            this.selectors.forEach(function (selector) {
                selector.removeEventListener('keypress');
            });
        }
    }, {
        key: "_targetAdded",
        value: function _targetAdded(target) {
        ...
        key: "_replacePasted",
        value: function _replacePasted(element, e) {
            var _this3 = this;
            ...
            insertAtCaret(element, content.split('').map(function (c) {
        ...
        key: "_badSelector",
        value: function _badSelector(selector) {
            if (!document.querySelector(selector)) {
                console.warn(this.constructor.name + ": An element with identifier '" + selector + "' not found. (Skipping...)");
                return true;
            }
        }
    }, {
